...
function recalcHeight(){biggestHeight = 0; $('.jqyc-month').css('height', 'inherit'); $('.jqyc-month').each(function(){var height = $(this).height(); if (height > biggestHeight){biggestHeight = height; console.log(height)}}); $('.jqyc-month').css('height', biggestHeight)}
